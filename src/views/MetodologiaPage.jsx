...
export default function ToursPage() {
  ...
  return (
    <>
        ...
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
              ...
              La metodología y actividades de este proyecto están diseñadas para involucrar activamente a los estudiantes y fomentar una integración significativa con la comunidad.
            </p>
          </div>
        </div>
      </section>
      ...
      <div className={styles.content} >
          <p className={styles.paragraph}>
              La metodología y actividades de este proyecto están diseñadas para involucrar activamente 
              a los estudiantes y fomentar una integración significativa con la comunidad.
            </p>
          </div>
        <div className={styles.group}>
          <div className={styles.content}>
            <h3 className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
              Sesiones interactivas para la enseñanza de programación con ejercicios prácticos y proyectos reales.
            </p>
          </div>
          <div className={styles.image}>
        ...
        <div className={styles.group}>
          <div className={styles.content}>
            <h3 className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
              Espacios para resolver dudas y fomentar la colaboración entre los participantes.
            </p>
          </div>
          <div className={styles.image}>
        ...
        <div className={styles.group}>
          <div className={styles.content}>
            <h3 className={styles.paragraph}>
              ...
              <p className={styles.paragraph}>
              Asesoramiento para identificar el camino profesional adecuado en tecnología.
            </p>
          </div>
          <div className={styles.image}>
      ...
      <Divider>
        <h1>Cronograma Trimestre 2324-3</h1>
      </Divider>
      ...
      <section className={styles.explain}>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
            Proyectos periódicos de programación para medir la 
            comprensión y aplicación práctica de Python por parte de los estudiantes
            </p>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
              Encuestas de autoevaluación para que los estudiantes reflexionen sobre su aprendizaje y progreso
            </p>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
              Revisión entre compañeros de los proyectos de código para fomentar la colaboración y el aprendizaje mutuo.
            </p>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
            Comentarios constructivos de los instructores sobre las tareas y proyectos para guiar el desarrollo de habilidades.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className={styles.explain}>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            y desarrolla habilidades para resolver problemas y pensar de forma lógica.
            </p>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
            La comunidad desarrolla habilidades de trabajo en equipo y establecen 
            conexiones profesionales en conjunto con su preparación
            </p>
          </div>
        </div>
        <div className={styles.group}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.paragraph}>
            Se reduce la brecha digital entre las comunidades de diferentes niveles socioeconómicos 
            convirtiéndose en ciudadanos más activos y participativos en la sociedad.
            </p>
          </div>
        </div>
      </section>
