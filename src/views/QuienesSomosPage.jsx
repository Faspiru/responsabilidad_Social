          ...
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                ¡Hola! Mi nombre es María Martínez, una apasionada estudiante de <b>Ingeniería de Sistemas</b> de 20 años, comprometida con el uso de la tecnología para el cambio social. 
                Creo firmemente que la educación en programación es una herramienta poderosa que puede transformar vidas, ofreciendo nuevas oportunidades y perspectivas de empleo. 
                Juntos, podemos construir una comunidad más fuerte y capacitada.
              </p>
            </div>
          </div>
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                ...
                Trimestre de la carrera de  <b>Ingeniería de Sistemas</b> en la UNIMET.
          ...
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                ...
                me encuentro en el octavo trimestre estudiando  <b>Ingeniería de Sistemas</b>. 
                Personalmente siento que esta propuesta de proyecto es
