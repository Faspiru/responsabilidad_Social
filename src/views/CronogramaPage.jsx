...
export default function CronogramaPage() {
  return (
    <>
      <Helmet title="Contexto y Comunidad"></Helmet>
      <header
        ...
        <div className={styles.aboutUs} style={{ paddingTop: "0px" }}>
          ...
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                <i>
                  Esto hace que la capacitación en habilidades demandadas, como
                  la programación en Python, sea crucial.
                </i>
              </p>
            </div>
          </div>
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                La programación en Python es relevante porque es un lenguaje de
                programación con amplias oportunidades de empleo, salarios
                competitivos y es relativamente fácil de aprender
              </p>
              <p className={styles.paragraph}>
                Además, Python se utiliza en múltiples sectores, lo que
                significa que aprender este lenguaje puede abrir muchas puertas
                en el ámbito laboral y ayudar a las personas a mejorar su
                calidad de vida.
              </p>
            </div>
          </div>
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                Con este proyecto, no solo les estás brindando una habilidad
                técnica valiosa, sino también la posibilidad de acceder a un
                mercado laboral global, mejorar su empleabilidad y, en última
                instancia, contribuir al crecimiento y desarrollo de sus
                comunidades.
              </p>
              <p className={styles.paragraph}>
                Este tipo de educación puede empoderar a las personas para que
                sean autosuficientes y generen un impacto positivo en su entorno
                (ACNUR, 2023).
              </p>
            </div>
          </div>
        ...
        <div className={styles.aboutUs}>
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                La población que se verá directamente beneficiada tiene diversas
                necesidades que se pueden cubrir gracias a este proyecto.
              </p>
            </div>
          </div>
          <div className={styles.Three}>
            <p className={styles.paragraph}>
              Entre dichas necesidades tenemos el{" "}
              <b>acceso a una educacion de calidad</b>, con{" "}
              <b>recursos tecnologicos</b> que no impongan un obstaculo en el
              aprendizaje.
            </p>
            <p className={styles.paragraph}>
              Al igual que <b>oportunidades de empleo</b> y conexiones, junto
              con las habilidades relevantes buscadas en el mercado laboral
            </p>
            <p className={styles.paragraph}>
              Y por ultimo el <b>apoyo y mentoría</b> para motivar y guiar a los
        ...
        <div className={styles.aboutUs}>
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                La Organización que colabora directamente con el proyecto
                establecido es la <b>Universidad Metropolitana</b>, puesto que
          ...
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                La población que se verá directamente beneficiada con la
                creación de este proyecto, son adolescentes y adultos entre
                15-25 años de comunidades vulnerables que se les dará la
                posibilidad de poder ampliar sus conocimientos y tener un camino
          ...
          <div className={styles.group}>
            ...
            <div className={styles.content}>
              ...
              <p className={styles.paragraph}>
                Los impactos de un proyecto de este estilo pueden ser profundos
                y variados:
              </p>
              <p className={styles.paragraph}>
                Entre dichos impactos en relacion con sus necesidades tenemos la
                mejora de habilidades técnicas demandadas que aumenten su
                empleabilidad. Lo cual propicia el desarrollo economico y la
                innovacion social, junto con el empoderamiento personal
              </p>
            </div>
          </div>
        </div>
